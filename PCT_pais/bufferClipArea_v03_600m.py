...
for i in rasterList:
    arcpy.RasterToPolygon_conversion(i, i+'_600m_shp', "SIMPLIFY", "VALUE")
    arcpy.Buffer_analysis(i+'_600m_shp', i+'_shp_buffer_600m', "600 Meters", "FULL", "ROUND", "ALL", "")
    ofile2=unicode(""+os.path.splitext(mosaic_reclass)[0]+'_'+i+'_shp_buffer_600m.shp')
    
    ofile3=unicode(""+os.path.splitext(mosaic_reclass)[0]+'_'+i+'_shp_buffer_600m_AreHA')
    
    #arcpy.Clip_analysis(mosaic_reclass, i+'_shp_buffer_600m', ofile2, "")
    arcpy.Clip_analysis("mosaic_reclass",i+'_shp_buffer_600m',ofile2,"")
    ...
    ofile4=unicode(""+os.path.splitext(i)[0]+'_TXT_600.txt')       
    summed_total =0   
